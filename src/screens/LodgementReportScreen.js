...
import { buildInstanceBody } from '../services/api';
      ...
      const results = await Promise.all(
        dates.map(async (date) => {
          try {
            ...
            const url = `${BASE_URL}/ARMODULE/DAILYLODGMENT`;
            const body = await buildInstanceBody({ ORDER_DATE: dateParam, SALESREP_NUMBER: salesrepNumber });
